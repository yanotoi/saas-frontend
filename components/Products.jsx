export default function Products({ products, selectedProducts, toggleProduct, name, setName, price, setPrice, stock, setStock, addProduct }) {
  return (
    <div>
      <h2>📦 Productos</h2>
      ...
      <ul>
        {products.map(p => (
          <li key={p.id}>
            <label>
              <input type="checkbox" onChange={() => toggleProduct(p)} />
